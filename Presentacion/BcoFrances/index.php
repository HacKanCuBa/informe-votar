...
<?php } elseif ($lang == 'en') { ?>
        <meta name="description" content="Vot.Ar: a bad election. Presentation for the Banco Frances, dec 2015" />
<?php } ?>
...
<?php } elseif ($lang == 'en') { ?>
        ...
        <meta name="twitter:description" content="Presentation for the Banco Frances, dec 2015" />

        <meta property="og:title" content="Vot.Ar: a bad election" />
        <meta property="og:description" content="Presentation for the Banco Frances, dec 2015" />
...
<?php } elseif ($lang == 'en') { ?>
                        ...
                        <br />
                        <ul>
                                <li><b class="scaling"><a class="link" href="vot_ar_una_mala_eleccion.php" target="_self">I want to see the presentation</a></b></li>
...
<?php } ?>
                        <p class="footnote"><a class="link-shadow" href="https://twitter.com/hashtag/VotArUnaMalaEleccion" target="_blank">#VotArUnaMalaEleccion</a></p>
		</div>
                <!-- -->
        </div>
